...
from src.context_matters.goal_relaxation import relax_goal, dict_replaceable_objects, relax_goal_pipeline
...
class ContextMattersPipeline(BasePipeline):
    ...
    def __init__(self, 
        ...
        self.workflow_iterations: int = workflow_iterations
    ...
    def _initialize_csv(self, csv_filepath):
        ...
        header = ["Task", "Scene", "Problem", "Planning Successful", "Grounding Successful", 
                ...
                "Goal Relaxation Time", "Total LLM Time",
    ...
    def _bidimensional_planning(self, **kwargs):
        ...
        while iteration < self.workflow_iterations:
                ...
                if task_possible.lower() == "false":
                    ...
                    if self.prevent_impossibility:
                        ...
                        return (problem_file_path, None, current_goal,
                                ...
                                domain_generation_time, problem_generation_time, problem_refinement_time, goal_relaxation_time, total_llm_time,
                                self.current_phase, "")
                else:
            ...
            plan, pddlenv_error_log, planner_error_log, planner_statistics = plan_with_output(
                domain_file_path, problem_dir, plan_file_path, search_flag='--search "astar(ff())"', timeout=60
            )      
        ...
        save_statistics(
            ...
            problem_decomposition_time=problem_refinement_time,  # Using problem_decomposition_time for refinement to match delta format
